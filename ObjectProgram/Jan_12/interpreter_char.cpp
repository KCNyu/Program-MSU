...
const char *
Scanner::TW    [] = { "", "and", "begin", "bool", "do", "else", "end", "if", "false", "int", "char", "not", "or", "program",
    ...
    while ( index < size ) {
        ...
        switch ( pc_el.get_type () ) {
            ...
            case LEX_ID:
                i = pc_el.get_value ();
                if ( TID[i].get_assign () ) {
                    if(TID[i].get_type() == LEX_CHAR){
                        args.push ( TID[i].get_value ().c );
                        break;
                    }
                    args.push ( TID[i].get_value ().n );
                    break;
                }
                else
            ...
            case LEX_READ:
                ...
                else if ( TID[i].get_type () == LEX_CHAR ) {
                    char c;
                    cout << "Input int value char for " << TID[i].get_name () << endl;
                    cin >> c;
                    TID[i].put_value (c);
                    TID[i].put_assign ();
                    break;
