...
template <typename T>
void ReadFile(const char *filename, vector<vector<T>> &data)
{
...
template <>
void ReadFile(const char *filename, vector<vector<complex<double>>> &data)
{
    ifstream matrix(filename);
    if (!matrix.is_open())
    {
...
template <typename T>
Matrix_LU<T>::Matrix_LU(const char *filename)
{
    ReadFile(filename, data);
    InitData();
}
template <typename T>
void Matrix_LU<T>::ReadBvec(const char *filename)
{
    string temp;
...
template <typename T>
void Matrix_LU<T>::ReadBvecPlus(const char *filename)
{
    string temp;
    ifstream vec(filename);
    if (!vec.is_open())
...
template <typename T>
void Matrix_LU<T>::WriteFile(string name, string index)
{
    ofstream mat;
    string prefix = name + " = ...\n  [";
    string suffix = ";\n   ";
...
template <typename T>
void Matrix_LU<T>::WriteFile(string index)
{
    WriteFile("L", index);
    WriteFile("U", index);
...
template <typename T>
void Matrix_LU<T>::DecompLU(string index)
{
...
template <typename T>
void Matrix_LU<T>::DecompLUP(string index)
{
    string Lmat = static_cast<string>("Lmat") + index + ".m";
    string Umat = static_cast<string>("Umat") + index + ".m";
...
template <typename T>
void Matrix_LU<T>::SolveSystem(const char *filename)
{
